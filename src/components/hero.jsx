  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="relative animate__animated animate__fadeIn">
        ...
        <div className="absolute -bottom-8 left-3/4 bg-light-green px-4 py-3 rounded-lg shadow-sm flex items-center gap-3 hover:bg-green-600 transition-all duration-300 cursor-pointer text-sm" >
