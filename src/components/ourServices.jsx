        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            <div className="transition-all duration-1000 ease-out">
              ...
              <p className="mx-auto text-xl text-text-black dark:text-gray-300">
                Comprehensive veterinary care tailored to your animal’s
                needs{" "}
              </p>
            </div>
          </div>
          <div className="grid gap-8 mb-20 md:grid-cols-2 lg:grid-cols-3">
            <div
              className={`group transition-all duration-1000 ease-out delay-200 p-8 rounded-2xl bg-main border border-border-gray`}
            >
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">
                Routine health checks, vaccinations, and de-worming to keep your
                animals healthy
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">
                In-house lab testing, X-rays, and ultrasound imaging for
                accurate diagnosis.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="mb-6 text-gray-600 dark:text-gray-300">
                Soft tissue and orthopedic surgery, dental cleaning, and
                emergency care.
              </p>
            </div>
          </div>
