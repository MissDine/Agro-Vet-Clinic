 ...
 *
 * @description
 * Displays clinic identity, quick links, service shortcuts, contact details,
 * and social icons.
 *
 * @returns {JSX.Element} Footer block rendered at the bottom of pages.
 *
 * @edgecase
 * Several links are placeholders (`#`) and should be replaced with real routes
 * or anchors before production use.
 */
function footer() {
  return (
    <div>
